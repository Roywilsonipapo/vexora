...
import { DigitsAnalysis } from '@/components/custom/digits-analysis';
import './custom/digits-analysis.css';
import type {
  AuthState,
  DerivAccount,
  ActiveSymbol,
...
export function DigitsView({
  ...
  return (
    ...
    >
      ...
      <div style={{ display: activeView === 'trade' || editMode ? 'contents' : 'none' }}>
